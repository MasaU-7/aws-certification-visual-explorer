...
export const INTEGRATION_VPC_SIZE: [number, number, number] = [9.5, 1.75, 6.05]
export const INTEGRATION_AWS_SIZE: [number, number, number] = [17.4, 2.08, 7.85]
export const INTEGRATION_AWS_CENTER: [number, number, number] = [1.75, 0.74, 0.22]
export const BUS_CENTER: [number, number, number] = [6.45, 0.72, 0.45]
...
const FIXED_POSITIONS: Record<string, [number, number, number]> = {
  ...
  sns: [5.55, 1.15, 1.05],
  sqs: [7.35, 1.15, 1.05],
  lambda: [5.55, 1.15, -0.45],
  sfn: [7.35, 1.15, -0.45],
  dynamodb: [5.55, 1.15, -1.95],
  batch: [7.35, 1.15, -1.95],
}
