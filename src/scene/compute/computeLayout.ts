...
export const COMPUTE_AWS_CENTER: [number, number, number] = [1.35, 0.74, 0.28]
export const MANAGED_CENTER: [number, number, number] = [5.95, 0.72, 1.35]
...
const FIXED_POSITIONS: Record<string, [number, number, number]> = {
  ...
  s3: [6.65, 1.15, 2.95],
  sqs: [6.65, 1.15, 1.35],
  dynamodb: [6.65, 1.15, -0.25],
  lambda: [5.15, 1.15, 1.35],
  asg: [0, 1.72, -1.15],
  batch: [-5.55, 0.55, 0.15],
}
