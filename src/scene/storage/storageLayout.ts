...
export const STORAGE_AWS_CENTER: [number, number, number] = [-1.95, 0.74, 0.28]
export const OBJECT_CENTER: [number, number, number] = [-6.95, 0.72, 1.05]
export const OBJECT_SIZE: [number, number, number] = [3.55, 1.35, 5.15]
export const STORAGE_ONPREM_CENTER: [number, number, number] = [-11.05, 0.64, 0.03]
...
const FIXED_POSITIONS: Record<string, [number, number, number]> = {
  ...
  igw: [0, 0.55, 3.55],
  transfer: [-6.95, 1.15, 2.85],
  datasync: [-6.95, 1.15, 1.25],
  s3: [-6.95, 1.15, -0.45],
  onprem: [-11.05, 0.95, 1.15],
  sgw: [-11.05, 0.95, -0.15],
  snowball: [-11.05, 0.95, -1.35],
}
