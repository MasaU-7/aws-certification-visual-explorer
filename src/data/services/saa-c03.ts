...
export const services: AwsService[] = [
  ...
  svc('vpc', 'VPC', 'network', 'network', 'city', ['network', 'isolation', 'subnet', 'routing'], ['ec2', 'rds', 'elb', 'direct-connect', 'site-to-site-vpn', 'transit-gateway', 'client-vpn'], ['web-application', 'high-availability', 'hybrid-network']),
  ...
  svc('direct-connect', 'Direct Connect', 'network', 'network', 'dx', ['hybrid', 'dedicated', 'private'], ['vpc', 'direct-connect-gateway', 'transit-gateway', 'site-to-site-vpn'], ['hybrid-network']),
  svc('site-to-site-vpn', 'Site-to-Site VPN', 'network', 'network', 'vpn', ['hybrid', 'encrypted', 'backup-path'], ['vpc', 'transit-gateway', 'direct-connect', 'client-vpn'], ['hybrid-network']),
  ...
  svc('direct-connect-gateway', 'Direct Connect GW', 'network', 'network', 'dxgw', ['hybrid', 'multi-region', 'multi-account'], ['direct-connect', 'transit-gateway', 'vpc'], ['hybrid-network']),
  svc('transit-gateway', 'Transit Gateway', 'network', 'network', 'tgw', ['hub-spoke', 'transit', 'peering'], ['vpc', 'direct-connect', 'site-to-site-vpn', 'direct-connect-gateway'], ['hybrid-network']),
