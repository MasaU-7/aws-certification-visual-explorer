 ...
 * Kinesis / Athena / QuickSight / S3 は VPC 外（Lake）。
 * EMR クラスタは VPC 内（EC2 上）。Athena は S3 を SQL。
 * QuickSight は Athena / Redshift / RDS を見る。Kinesis は stream。
 */
export const analyticsCity: VpcCityDefinition = {
  ...
  occupants: [
    ...
    { id: 'emr-b', kind: 'service', label: 'EMR', az: 'az-b', tier: 'private', serviceId: 'emr' },
  ...
  flows: [
    ...
    L('emr-launch-b', 'emr', 'emr-b', 'scale'),
    L('emr-on-a', 'emr-a', 'ec2-a', 'app', 'attach', 'none'),
    L('emr-on-b', 'emr-b', 'ec2-b', 'app', 'attach', 'none'),
    L('emr-ha', 'emr-a', 'emr-b', 'data', 'path', 'both'),
    L('emr-s3-a', 'emr-a', 's3', 'data', 'access'),
    L('emr-s3-b', 'emr-b', 's3', 'data', 'access'),
    ...
    L('rds-qs-b', 'rds-b', 'quicksight', 'data', 'access'),
    ...
    L('out-emr-b', 'emr-b', 'nat-b', 'egress'),
